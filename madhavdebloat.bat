...
REM PowerShell -Command "Get-AppxPackage *MicrosoftOfficeHub* | Remove-AppxPackage"
...
REM PowerShell -Command "Get-AppxPackage *WindowsSoundRecorder* | Remove-AppxPackage"
